x <- rbind(read.table("/data/tmp/lcEr3_4.txt", header = T), read.table("/data/tmp/lcEr3_5.txt", header = T))
...
#340.61, Par. =  6.95583e-05   -4.43936   0.607568    1.44641   0.589154
#
xx <- x[sample(nrow(x), 100000),]
t1 <- with(xx, c(rbind(npp01,npp02,npp03,npp04,npp05,npp06,npp07,npp08,npp09,npp10,npp11,npp12)))
a <- nlsLM(t1 ~ nppMod8(c(c0,c1,c2,300,c4,0.06,0.59,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=xx, start=list(c0=1.59344e-06, c1=2.4, c2=2.2, c4=5), trace=T, control = nls.lm.control(maxiter=999))
#38825.5, Par. =  7.54653e-07    3.39758    2.39893    5.10519

xx$nppEst0 <- rowSums(matrix(predict(a), ncol=12, byrow=T))
plot(xx$npp, xx$nppEst0, pch=".")
cor(xx$npp, xx$nppEst0)

a0 <- nls(npp ~ c0[soil] * nppEst0, data=xx, start=list(c0=rep(1,23)))
xx$nppEst1 <- predict(a0)
plot(xx$npp, xx$nppEst1, pch=".")
cor(xx$npp, xx$nppEst1)

summary(a0)
###
     Estimate Std. Error t value Pr(>|t|)    
c01  0.997382   0.003902  255.63   <2e-16 ***
c02  1.164807   0.005295  219.98   <2e-16 ***
c03  1.137406   0.004391  259.02   <2e-16 ***
c04  1.157535   0.005362  215.86   <2e-16 ***
c05  1.025785   0.012800   80.14   <2e-16 ***
c06  1.016309   0.007938  128.03   <2e-16 ***
c07  0.922417   0.003946  233.76   <2e-16 ***
c08  1.078434   0.012350   87.32   <2e-16 ***
c09  1.033414   0.003753  275.33   <2e-16 ***
c010 0.960146   0.015471   62.06   <2e-16 ***
c011 1.018151   0.005886  172.98   <2e-16 ***
c012 1.064526   0.006763  157.41   <2e-16 ***
c013 1.083873   0.008176  132.56   <2e-16 ***
c014 1.061930   0.010629   99.91   <2e-16 ***
c015 1.108677   0.007049  157.29   <2e-16 ***
c016 1.053499   0.005875  179.32   <2e-16 ***
c017 1.025711   0.006474  158.44   <2e-16 ***
c018 0.942647   0.004388  214.81   <2e-16 ***
c019 1.277620   0.040011   31.93   <2e-16 ***
c020 1.014716   0.005217  194.50   <2e-16 ***
c021 1.114794   0.019745   56.46   <2e-16 ***
c022 1.009307   0.003898  258.90   <2e-16 ***
c023 1.115872   0.027848   40.07   <2e-16 ***
###
