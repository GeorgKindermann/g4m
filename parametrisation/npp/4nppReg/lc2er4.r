x <- rbind(read.table("/data/tmp/lcEr2_4.txt", header = T), read.table("/data/tmp/lcEr2_5.txt", header = T))
...
#12.4076, Par. =  0.000211252   -6.83794   0.216581    1.00762   0.642013
t1 <- with(x, c(rbind(npp01,npp02,npp03,npp04,npp05,npp06,npp07,npp08,npp09,npp10,npp11,npp12)))
a <- nlsLM(t1 ~ nppMod8(c(c0,c1,c2,300,c4,0.06,0.64,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=x, start=list(c0=0.0024, c1=-1.8, c2=0.5, c4=1), trace=T, control = nls.lm.control(maxiter=999))
#13032.5, Par. =  1.12058e-06     4.3106    2.48811    5.28351
...
c01   0.93566    0.01296   72.22   <2e-16 ***
c02   1.04938    0.01757   59.73   <2e-16 ***
c03   0.99955    0.01436   69.59   <2e-16 ***
c04   1.17027    0.01150  101.80   <2e-16 ***
c05   0.92923    0.02446   37.99   <2e-16 ***
c06   0.90336    0.01306   69.14   <2e-16 ***
c07   1.00938    0.01734   58.21   <2e-16 ***
c08   1.02759    0.03270   31.43   <2e-16 ***
c09   0.95376    0.01903   50.12   <2e-16 ***
c010  0.90328    0.05673   15.92   <2e-16 ***
c011  1.00736    0.02205   45.69   <2e-16 ***
c012  0.99617    0.02481   40.15   <2e-16 ***
c013  1.14578    0.02375   48.24   <2e-16 ***
c014  1.09325    0.03831   28.53   <2e-16 ***
c015  1.25368    0.01072  116.91   <2e-16 ***
c016  1.11511    0.01370   81.42   <2e-16 ***
c017  0.92586    0.01658   55.84   <2e-16 ***
c018  0.99376    0.02153   46.15   <2e-16 ***
c019  1.10367    0.03126   35.30   <2e-16 ***
c020  0.90914    0.02447   37.16   <2e-16 ***
c021  0.96348    0.01804   53.39   <2e-16 ***
c022  0.94270    0.01307   72.14   <2e-16 ***
c023  1.41604    0.01973   71.76   <2e-16 ***
###
