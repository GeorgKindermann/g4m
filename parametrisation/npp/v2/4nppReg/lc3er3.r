x <- read.table("/data/tmp/lcEr3_3.txt", header = T)
...
#3792.2, Par. =  2.2471e-06    2.19876    1.56872    2.76013   0.250285
#
t1 <- with(x, c(rbind(npp01,npp02,npp03,npp04,npp05,npp06,npp07,npp08,npp09,npp10,npp11,npp12)))
a <- nlsLM(t1 ~ nppMod8(c(c0,c1,c2,300,c4,0.06,0.25,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=x, start=list(c0=2.2471e-06, c1=2.2, c2=1.56, c4=2.76), trace=T, control = nls.lm.control(maxiter=999))
#28441.4, Par. =  1.50349e-07    7.07274    2.54163    4.00133
...
c01  0.862190   0.010423   82.72   <2e-16 ***
c02  1.145883   0.014005   81.82   <2e-16 ***
c03  1.135764   0.016439   69.09   <2e-16 ***
c04  0.950486   0.012207   77.87   <2e-16 ***
c05  1.102457   0.023647   46.62   <2e-16 ***
c06  1.030473   0.015388   66.96   <2e-16 ***
c07  0.956814   0.019761   48.42   <2e-16 ***
c08  0.975896   0.018049   54.07   <2e-16 ***
c09  1.170444   0.018345   63.80   <2e-16 ***
c010 1.003162   0.020583   48.74   <2e-16 ***
c011 1.169161   0.016130   72.48   <2e-16 ***
c012 1.053181   0.040283   26.14   <2e-16 ***
c013 1.126635   0.018529   60.80   <2e-16 ***
c014 1.232963   0.029751   41.44   <2e-16 ***
c015 0.864202   0.018039   47.91   <2e-16 ***
c016 1.179097   0.013886   84.91   <2e-16 ***
c017 0.774995   0.012829   60.41   <2e-16 ***
c018 0.995233   0.013676   72.77   <2e-16 ***
c019 1.321486   0.015085   87.60   <2e-16 ***
c020 1.032954   0.017985   57.43   <2e-16 ***
c021 1.041349   0.023973   43.44   <2e-16 ***
c022 1.029158   0.012150   84.71   <2e-16 ***
c023 1.056834   0.008651  122.16   <2e-16 ***
###
