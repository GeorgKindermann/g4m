t1 <- read.table("/data/tmp/lcEr2_1.txt", header = T, nrows = 5)
t2 <- sapply(t1, class)
x <- read.table("/data/tmp/lcEr2_1.txt", header = T, colClasses = t2)
gc()

set.seed(1)
x <- x[sample(nrow(x), 1000000),]
gc()
...
a <- nlsLM(t1 ~ nppMod8(c(c0,0,c2,300,c4,0.06,c6,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=t2, start=list(c0=0.002, c2=1, c4=1, c6=0.9), trace=T, control = nls.lm.control(maxiter=999))
#51773.2, Par. =  0.00319845  -0.857609   0.217389   0.776417
...
#60444.4, Par. =  5.34759e-09    2.36129

t1 <- with(x, c(rbind(npp01,npp02,npp03,npp04,npp05,npp06,npp07,npp08,npp09,npp10,npp11,npp12)))
a <- nlsLM(t1 ~ nppMod8(c(c0,8,c2,300,2.36,0.025,0.6,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=x, start=list(c0=7.99593e-08, c2=3), trace=T, control = nls.lm.control(maxiter=999))
#1.89296e+06, Par. =  6.97374e-07    2.08263
...
c01  1.027236   0.001019  1008.5   <2e-16 ***
c02  0.930810   0.005300   175.6   <2e-16 ***
c03  1.026614   0.001996   514.4   <2e-16 ***
c04  1.058107   0.004539   233.1   <2e-16 ***
c05  1.044301   0.002856   365.6   <2e-16 ***
c06  1.088828   0.003951   275.6   <2e-16 ***
c07  1.284784   0.003373   380.9   <2e-16 ***
c08  0.997171   0.002766   360.5   <2e-16 ***
c09  1.030403   0.004296   239.9   <2e-16 ***
c010 0.930521   0.001862   499.8   <2e-16 ***
c011 0.917611   0.002505   366.3   <2e-16 ***
c012 1.071603   0.002506   427.7   <2e-16 ***
c013 1.167654   0.002242   520.8   <2e-16 ***
c014 1.063758   0.001843   577.1   <2e-16 ***
c015 1.260789   0.002637   478.1   <2e-16 ***
c016 1.139207   0.002499   455.8   <2e-16 ***
c017 0.999577   0.001837   544.1   <2e-16 ***
c018 0.966556   0.001446   668.6   <2e-16 ***
c019 1.161625   0.003346   347.2   <2e-16 ***
c020 0.990053   0.001827   542.0   <2e-16 ***
c021 1.105658   0.002457   450.1   <2e-16 ***
c022 1.056113   0.001930   547.3   <2e-16 ***
c023 1.107417   0.001806   613.1   <2e-16 ***
###
