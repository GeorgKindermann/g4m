x <- read.table("/data/tmp/lcEr4_3.txt", header = T)
...
a <- nlsLM(t1 ~ nppMod8(c(c0,c1,c2,300,c4,0.06,c6,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=t2, start=list(c0=1.70168e-06, c1=5, c2=1.9, c4=3.7, c6=0.2), trace=T, control = nls.lm.control(maxiter=999))
#47966.4, Par. =  6.21551e-06    1.04505    1.47763    2.87979   0.257242
#

t1 <- with(x, c(rbind(npp01,npp02,npp03,npp04,npp05,npp06,npp07,npp08,npp09,npp10,npp11,npp12)))
a <- nlsLM(t1 ~ nppMod8(c(c0,c1,c2,300,c4,0.06,0.26,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=x, start=list(c0=6.21551e-06, c1=1, c2=1.5, c4=2.9), trace=T, control = nls.lm.control(maxiter=999))
#1.38463e+06, Par. =  6.30082e-09    9.35918    3.66485    4.64592
...
c01  0.8426849  0.0028306   297.7   <2e-16 ***
c02  1.1336508  0.0020667   548.5   <2e-16 ***
c03  0.9219486  0.0057336   160.8   <2e-16 ***
c04  1.0428545  0.0032058   325.3   <2e-16 ***
c05  1.1223109  0.0028443   394.6   <2e-16 ***
c06  0.8339236  0.0020321   410.4   <2e-16 ***
c07  1.0641686  0.0055170   192.9   <2e-16 ***
c08  0.5452793  0.0016814   324.3   <2e-16 ***
c09  1.0681361  0.0051012   209.4   <2e-16 ***
c010 1.0280533  0.0011072   928.6   <2e-16 ***
c011 1.0013517  0.0028667   349.3   <2e-16 ***
c012 0.6224940  0.0054889   113.4   <2e-16 ***
c013 1.2335694  0.0051426   239.9   <2e-16 ***
c014 1.1491972  0.0034437   333.7   <2e-16 ***
c015 1.0465842  0.0034933   299.6   <2e-16 ***
c016 0.9879109  0.0011697   844.6   <2e-16 ***
c017 1.1978397  0.0042220   283.7   <2e-16 ***
c018 0.9430111  0.0017698   532.8   <2e-16 ***
c019 1.0909037  0.0018337   594.9   <2e-16 ***
c020 1.1027924  0.0039686   277.9   <2e-16 ***
c021 1.0124663  0.0039311   257.6   <2e-16 ***
c022 1.2082930  0.0030732   393.2   <2e-16 ***
c023 1.0756028  0.0008089  1329.7   <2e-16 ***
###
