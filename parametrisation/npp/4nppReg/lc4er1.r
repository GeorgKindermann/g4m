x <- read.table("/data/tmp/lcEr4_1.txt", header = T)
...
a <- nlsLM(t1 ~ nppMod8(c(c0,8,3.5,300,c4,0.025,0.6,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=t2, start=list(c0=0.002, c4=1), trace=T, control = nls.lm.control(maxiter=999))
#861832, Par. =  4.17991e-09    2.71592
a <- nlsLM(t1 ~ nppMod8(c(c0,4,2,300,c4,0.025,c6,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=t2, start=list(c0=0.00001, c4=2, c6=0.4), trace=T, control = nls.lm.control(maxiter=999))
#812455, Par. =  4.44671e-07    1.82371   0.422847

t1 <- with(x, c(rbind(npp01,npp02,npp03,npp04,npp05,npp06,npp07,npp08,npp09,npp10,npp11,npp12)))
a <- nlsLM(t1 ~ nppMod8(c(c0,8,c2,300,c4,0.025,0.42,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=x, start=list(c0=4.44671e-07, c2=2, c4=1.8), trace=T, control = nls.lm.control(maxiter=999))
#1.252e+06, Par. =  1.92824e-05   0.651994   0.986363

a <- nlsLM(t1 ~ nppMod8(c(c0,8,c2,300,1.82,0.025,0.42,50,0.002,0.85,20), nTage, rbind(tmean01,tmean02,tmean03,tmean04,tmean05,tmean06,tmean07,tmean08,tmean09,tmean10,tmean11,tmean12), rbind(prec01,prec02,prec03,prec04,prec05,prec06,prec07,prec08,prec09,prec10,prec11,prec12), rbind(radi01,radi02,radi03,radi04,radi05,radi06,radi07,radi08,radi09,radi10,radi11,radi12), elevation, whc), data=x, start=list(c0=1.92824e-05, c2=2), trace=T, control = nls.lm.control(maxiter=999))
#1.25754e+06, Par. =  3.17454e-07    1.98803
...
c01  1.014203   0.002084  486.61   <2e-16 ***
#c02  0.655291   0.033865   19.35   <2e-16 ***
c03  0.932896   0.005338  174.78   <2e-16 ***
#c04  1.681138   0.024143   69.63   <2e-16 ***
c05  0.909431   0.005088  178.73   <2e-16 ***
#c06  0.724058   0.003848  188.17   <2e-16 ***
c07  1.170861   0.002111  554.77   <2e-16 ***
c08  0.730898   0.014088   51.88   <2e-16 ***
#c09  0.584047   0.006090   95.90   <2e-16 ***
c010 0.946718   0.005458  173.44   <2e-16 ***
c011 0.868518   0.008313  104.48   <2e-16 ***
c012 0.866705   0.004049  214.05   <2e-16 ***
c013 0.973624   0.006352  153.28   <2e-16 ***
c014 1.075178   0.008499  126.51   <2e-16 ***
#c015 2.262815   0.004997  452.82   <2e-16 ***
c016 0.867673   0.008803   98.56   <2e-16 ***
c017 0.700617   0.009261   75.65   <2e-16 ***
c018 0.794007   0.004479  177.27   <2e-16 ***
#c019 1.981404   0.010698  185.21   <2e-16 ***
c020 1.001099   0.004942  202.56   <2e-16 ***
c021 1.352024   0.008214  164.60   <2e-16 ***
c022 1.284358   0.009363  137.17   <2e-16 ***
c023 1.225052   0.010852  112.89   <2e-16 ***
###
