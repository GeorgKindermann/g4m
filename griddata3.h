//   Name:          GridData class 1.3 + output to file
//   Author:        Andriy Bun
//   Date:          9.06.2008
...
class griddata
 {
  ...
  public:
      ...
      void PrintToFile(string fileName);      // print array to file
      void PrintToFilePrev(string fileName);  // print previous year array to file
...
void griddata::PrintToFile(string fileName)
 {
  ofstream f;
...
void griddata::PrintToFilePrev(string fileName)
 {
  ofstream f;
  fileName = "output\\" + fileName + ".txt";
  f.open(fileName.c_str(),ios::out);
